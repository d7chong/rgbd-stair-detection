...
//                  [THRESHOLD]
const float k_height_threshold = 0.005f;  // Around voxel grid value
const float k_length_threshold = 0.03f;  // Some stairs in the dataset have lengths around 23cm, thus I had to increase the threshold to be safe

// -------------------------------------------------------------

//                  [HEIGHT]

// ACTUAL_HEIGHT = 7cm | Error: 7 ± 2 cm
const float k_height_min = 0.04f;  // Min height is 4 cm
const float k_height_max = 0.08f;  // Max height is 9 cm

// -------------------------------------------------------------

//                  [LENGTH]

// ACTUAL_LENGTH = 17cm | Error: 
const float k_length_min = 0.09f;  // Min length is 8 cm
const float k_length_max = 0.24f;  // Max length is 40 cm

// -------------------------------------------------------------

//                  [WIDTH]

// ACTUAL_WIDTH = 40cm | Error: 40 ± 20 cm
const float k_width_min = 0.20f;  // Min length is 20 cm
const float k_width_max = 0.60f;  // Max length is 60 cm
